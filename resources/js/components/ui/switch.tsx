...
function Switch({
  ...
  return (
    <SwitchPrimitive.Root
      data-slot="switch"
      className={cn(
        // Track (background) warna lebih kontras di dark mode!
        ...
        // Track checked/unchecked
        "data-[state=checked]:bg-primary data-[state=unchecked]:bg-input",
        "dark:data-[state=checked]:bg-primary dark:data-[state=unchecked]:bg-neutral-700/80", // <--- track dark mode
        className
      )}
      {...props}
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          // Bulatan: light = coklat, dark = putih
          "pointer-events-none block size-4 rounded-full ring-0 transition-transform",
          "data-[state=checked]:translate-x-[calc(100%-2px)] data-[state=unchecked]:translate-x-0",
          "bg-[#a97c50] dark:bg-white"
        )}
      />
    </SwitchPrimitive.Root>
  )
